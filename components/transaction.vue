<template>
  <div
    class="grid grid-cols-3 py-4 border-b border-gray-200 dark:border-gray-800 text-gray-900 dark:text-gray-100 col-span-2"
  >
    <div class="flex space-x-2 items-center justify-between space-x-4">

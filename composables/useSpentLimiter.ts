...
interface UserLimiterData {
  limiterValue?: number;
  limiterTimePeriod?: string;
  limiterType?: "overall" | "category";
  limiterCategories?: CategoryLimit[];
}

interface SpentLimiterReturn {
  categoryAlert: ComputedRef<boolean>;
  overallAlert: ComputedRef<boolean>;
  categoryAlertMessage: Ref<string>;
  overallAlertMessage: Ref<string>;
}

export const createLimitAlert = (
  currentValue: number,
  limitValue: number,
  period: string,
  type: string
...
export const useSpentLimiter = (
  period: Ref<string>,
  expenseValue: Ref<number>,
  userData?: UserLimiterData | null,

import { c as __nuxt_component_1$2, d as __nuxt_component_4, e as appConfig, f as useAppConfig, g as classNames, b as useSupabaseUser, h as __nuxt_component_2$1, _ as _export_sfc, i as useNuxtApp, j as asyncDataDefaults, k as createError } from './server.mjs';
...
import { u as useFormEvents, _ as __nuxt_component_1$1$1, a as __nuxt_component_1$3, b as useAppToast } from './useAppToast-BHAQYvqX.mjs';
...
import { _ as __nuxt_component_1$4 } from './Card-BUhI-QwE.mjs';
...
import { u as useCategoryList } from './useCategoryList-CC-aFo4H.mjs';
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UIcon = __nuxt_component_1$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-44b8ef95><div class="${ssrRenderClass([[__props.color], "font-bold"])}" data-v-44b8ef95>${ssrInterpolate(__props.title)}</div><div class="text-2xl font-extrabold text-black dark:text-white mb-2" data-v-44b8ef95>`);
      if (__props.loading) {
        _push(ssrRenderComponent(_component_USkeleton, { class: "h-8 w-full" }, null, _parent));
      } else {
        _push(`<div data-v-44b8ef95>${ssrInterpolate(unref(currency))}</div>`);
      }
      _push(`</div><div data-v-44b8ef95>`);
      if (__props.loading) {
        _push(ssrRenderComponent(_component_USkeleton, { class: "h-6 w-full" }, null, _parent));
      } else {
        _push(`<div class="flex space-x-1 items-center text-sm" data-v-44b8ef95>`);
        _push(ssrRenderComponent(_component_UIcon, {
          name: unref(icon),
          class: ["w-6 h-6", { green: unref(trendingUp), red: !unref(trendingUp) }]
        }, null, _parent));
        _push(`<span class="text-gray-500 dark:text-gray-400" data-v-44b8ef95>${ssrInterpolate(unref(percentageTrend))} vs last period </span></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-44b8ef95"]]);
...
//# sourceMappingURL=index-J5B2acsi.mjs.map

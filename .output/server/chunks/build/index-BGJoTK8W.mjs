import { c as __nuxt_component_1$2, d as __nuxt_component_4, e as appConfig, f as useAppConfig, g as classNames, u as useSupabaseUser, h as __nuxt_component_2$1, _ as _export_sfc, i as useNuxtApp, j as asyncDataDefaults, k as createError } from './server.mjs';
import { defineComponent, computed, ref, watch, provide, h, cloneVNode, reactive, toRaw, onMounted, Fragment, watchEffect, inject, onUnmounted, nextTick, unref, getCurrentInstance, Teleport, normalizeClass, useSSRContext, withAsyncContext, isRef, withCtx, createVNode, withKeys, shallowRef, toRefs, mergeProps, toDisplayString, openBlock, createBlock, createCommentVNode, withModifiers, createTextVNode, resolveComponent, resolveDynamicComponent, renderSlot, renderList, Transition, toRef, onServerPrefetch } from 'vue';
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-3d66fffd"]]);
const _sfc_main$3 = {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_TransactionModal = __nuxt_component_2;
      const _component_UButton = __nuxt_component_2$1;
      const _component_UFormGroup = __nuxt_component_1$1$1;
      const _component_UInput = __nuxt_component_1$3;
...
//# sourceMappingURL=index-BGJoTK8W.mjs.map

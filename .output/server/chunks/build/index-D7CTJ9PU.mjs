...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSlot } from 'vue/server-renderer';
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$4]]);
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$3]]);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__scopeId", "data-v-a0a17d28"]]);
const _sfc_main$9 = {
  __name: "LineChart",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LineChart = _sfc_main$9;
      const _component_DoughnutChart = _sfc_main$8;
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c7c5879a"]]);
const _sfc_main$3 = {
...
const useSpentLimiter = (period, expenseValue, userData) => {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_TransactionsCharts = _sfc_main$7;
      ...
      const _component_USkeleton = __nuxt_component_9;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-screen" }, _attrs))} data-v-e8a478e0><section class="flex items-center justify-between mb-10" data-v-e8a478e0><h1 class="text-xl font-extrabold" data-v-e8a478e0>Summary</h1><div data-v-e8a478e0>`);
      ...
      _push(`</div></section><section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10" data-v-e8a478e0>`);
      ...
      _push(`</section>`);
      if (!unref(pending)) {
        _push(`<section class="mb-10" data-v-e8a478e0>`);
      ...
      if (!unref(pending) && unref(spentLimiterOverallAlert)) {
        _push(`<section style="${ssrRenderStyle({ "padding-bottom": "20px" })}" data-v-e8a478e0>`);
        _push(ssrRenderComponent(_component_UAlert, {
          ...
          description: unref(spentLimiterAlertMessage)
        }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="flex justify-between mb-10" data-v-e8a478e0><div data-v-e8a478e0><h2 class="text-2xl font-extrabold" data-v-e8a478e0>Transaction</h2><div class="text-gray-500 dark:text-gray-400" data-v-e8a478e0> You have ${ssrInterpolate(unref(filteredStats).incomeCount)} incomes and ${ssrInterpolate(unref(filteredStats).expenseCount)} expenses this period. </div></div><div class="flex items-center gap-4" data-v-e8a478e0><div style="${ssrRenderStyle(unref(isSearchOpen) ? null : { display: "none" })}" class="w-60" data-v-e8a478e0>`);
      ...
      _push(`</div></section><div class="flex-1 overflow-y-auto" data-v-e8a478e0>`);
      if (!unref(pending)) {
        _push(`<section data-v-e8a478e0><!--[-->`);
        ssrRenderList(unref(filteredTransactions), (transactionsOnDay, period) => {
          _push(`<div class="mb-6" data-v-e8a478e0>`);
          ...
          _push(`<div style="${ssrRenderStyle(!unref(collapsedGroups)[period] ? null : { display: "none" })}" class="pl-6 border-l-2 border-gray-100 dark:border-gray-800 ml-2" data-v-e8a478e0><!--[-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e8a478e0"]]);

export { index as default };
//# sourceMappingURL=index-D7CTJ9PU.mjs.map

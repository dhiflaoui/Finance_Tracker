import { t as useHead, u as useSupabaseUser, s as useState, n as navigateTo, a as __nuxt_component_0$2, c as __nuxt_component_1, h as __nuxt_component_3, d as __nuxt_component_5 } from './server.mjs';
import { g as __nuxt_component_2, _ as __nuxt_component_4 } from './Dropdown-7XBCz2fC.mjs';
import { mergeProps, useSSRContext, ref, computed, withCtx, createTextVNode, unref, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrInterpolate } from 'vue/server-renderer';
import { u as useAvatarUrl } from './useAvatarUrl-BqOT5WeK.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UDropdown, {
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between items-center p-2"${_scopeId}><h3 class="font-semibold"${_scopeId}>Notifications</h3>`);
            ...
            return [
              createVNode("div", { class: "flex justify-between items-center p-2" }, [
                createVNode("h3", { class: "font-semibold" }, "Notifications"),
                unref(notifications).length ? (openBlock(), createBlock(_component_UButton, {
                  key: 0,
                  size: "xs",
                  variant: "ghost",
                  onClick: clearNotifications,
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UButton, {
              ...
              color: unref(hasUnreadNotifications) ? "red" : "gray",
              variant: "ghost"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(unreadNotificationsCount)) {
                    _push3(ssrRenderComponent(_component_UBadge, {
                      value: unref(unreadNotificationsCount),
                      position: "top-right",
                      color: "red"
                  ...
                  return [
                    unref(unreadNotificationsCount) ? (openBlock(), createBlock(_component_UBadge, {
                      key: 0,
                      value: unref(unreadNotificationsCount),
                      position: "top-right",
                      color: "red"
...
//# sourceMappingURL=default-bqIQfkup.mjs.map

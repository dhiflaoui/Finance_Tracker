import { c as __nuxt_component_1$1, d as __nuxt_component_5$1, e as appConfig, f as useAppConfig, g as classNames, _ as _export_sfc, u as useSupabaseUser, h as __nuxt_component_3 } from './server.mjs';
import { defineComponent, computed, ref, watch, provide, h, cloneVNode, reactive, toRaw, onMounted, Fragment, watchEffect, inject, onUnmounted, nextTick, unref, getCurrentInstance, Teleport, normalizeClass, useSSRContext, withAsyncContext, mergeProps, isRef, shallowRef, toRefs, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, withModifiers, createTextVNode, resolveComponent, resolveDynamicComponent, renderSlot, renderList, Transition } from 'vue';
import { useDebounceFn, computedAsync } from '@vueuse/core';
import { q as defu } from '../runtime.mjs';
import { c as c$1, f as f$2, w as w$2, t as t$3, i as i$2, l as l$2, a as i$1$1, u as u$1$1, p, s as s$2, b as usePopper, n as n$1, d as w$1$1, e as t$1$1, _ as __nuxt_component_4, g as __nuxt_component_2 } from './Dropdown-7XBCz2fC.mjs';
import { u as useFormEvents, _ as __nuxt_component_1$1$1, a as __nuxt_component_1$2 } from './FormGroup-CjdXc7SC.mjs';
...
import { _ as __nuxt_component_0$2 } from './Card-J1mmD4IC.mjs';
import { _ as __nuxt_component_0$3 } from './Form-Bw62B85A.mjs';
...
import { u as useAppToast } from './useAppToast-tws-mLie.mjs';
...
const __nuxt_component_8 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$1]]);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-a0a17d28"]]);
const _sfc_main$7 = {
  __name: "LineChart",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LineChart = _sfc_main$7;
      const _component_DoughnutChart = _sfc_main$6;
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UForm = __nuxt_component_0$3;
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c7c5879a"]]);
const _sfc_main$2 = {
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-2ae55559"]]);
const _sfc_main$1 = {
  __name: "transaction",
  __ssrInlineRender: true,
  props: {
      ...
      _push(ssrRenderComponent(_component_UDropdown, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(__nuxt_component_5, {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const filteredTransactions = computed(() => {
      ...
      Object.entries(transactions).forEach(([date, transactionList]) => {
        const matchingTransactions = transactionList.filter(
          (transaction) => {
            var _a22, _b, _c;
            return ((_a22 = transaction.description) == null ? void 0 : _a22.toLowerCase().includes(query)) || ((_b = transaction.category) == null ? void 0 : _b.toLowerCase().includes(query)) || ((_c = transaction.amount) == null ? void 0 : _c.toString().includes(query));
          }
        );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_USelectMenu = __nuxt_component_0$1;
      const _component_Trend = __nuxt_component_1;
      const _component_TransactionsCharts = _sfc_main$5;
      const _component_UInput = __nuxt_component_1$1$1;
      const _component_UButton = __nuxt_component_3;
      const _component_TransactionModal = __nuxt_component_5;
      const _component_DailyTransactionSummary = __nuxt_component_6;
      const _component_Transaction = _sfc_main$1;
      const _component_USkeleton = __nuxt_component_8;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-screen" }, _attrs))} data-v-23089be1><section class="flex items-center justify-between mb-10" data-v-23089be1><h1 class="text-xl font-extrabold" data-v-23089be1>Summary</h1><div data-v-23089be1>`);
      ...
      _push(`</div></section><section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10" data-v-23089be1>`);
      ...
      _push(`</section>`);
      if (!unref(pending)) {
        _push(`<section class="mb-10" data-v-23089be1>`);
      ...
      _push(`<section class="flex justify-between mb-10" data-v-23089be1><div data-v-23089be1><h2 class="text-2xl font-extrabold" data-v-23089be1>Transaction</h2><div class="text-gray-500 dark:text-gray-400" data-v-23089be1> You have ${ssrInterpolate(unref(filteredStats).incomeCount)} incomes and ${ssrInterpolate(unref(filteredStats).expenseCount)} expenses this period. </div></div><div class="flex items-center gap-4" data-v-23089be1><div style="${ssrRenderStyle(unref(isSearchOpen) ? null : { display: "none" })}" class="w-60" data-v-23089be1>`);
      ...
      _push(`</div></section><div class="flex-1 overflow-y-auto" data-v-23089be1>`);
      if (!unref(pending)) {
        _push(`<section data-v-23089be1><!--[-->`);
        ssrRenderList(unref(filteredTransactions), (transactionsOnDay, period) => {
          _push(`<div class="mb-6" data-v-23089be1>`);
          ...
          _push(`<div style="${ssrRenderStyle(!unref(collapsedGroups)[period] ? null : { display: "none" })}" class="pl-6 border-l-2 border-gray-100 dark:border-gray-800 ml-2" data-v-23089be1><!--[-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-23089be1"]]);

export { index as default };
//# sourceMappingURL=index-B2IOjZGY.mjs.map

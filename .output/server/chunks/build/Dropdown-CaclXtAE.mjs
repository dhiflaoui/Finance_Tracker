...
import { defineComponent, ref, computed, provide, onMounted, onUnmounted, watchEffect, nextTick, useSSRContext, cloneVNode, h as h$1, Fragment, inject, mergeProps, resolveComponent, withCtx, renderSlot, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, renderList, Transition } from 'vue';
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m;
  let i2 = (m = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : void 0 : e2 == null ? void 0 : e2.ownerDocument) != null ? m : void 0, n2 = Array.isArray(e2) ? t2 ? O$1(e2) : e2 : E$1(e2);
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o2, { slots: M, attrs: i$12 }) {
  ...
  let g2 = s$1(computed(() => ({ as: o2.as, type: M.type })), e2.buttonRef);
  return () => {
    var n2;
...
export { A$1 as A, E, N, O$1 as O, P, S$1 as S, T, __nuxt_component_3 as _, i$5 as a, i$3 as b, c, i$1 as d, u$1 as e, f, w$2 as g, h, i, s2 as j, S as k, l, c$2 as m, usePopper as n, o$2 as o, p, o$1 as q, n$1 as r, s$1 as s, t, u$3 as u, w$1 as v, w, N$1 as x, T$1 as y, t$1 as z };
//# sourceMappingURL=Dropdown-CaclXtAE.mjs.map

...
import { mergeProps, useSSRContext, computed, unref, withCtx, createTextVNode, createVNode, toDisplayString } from 'vue';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "flex justify-between items-center mt-10" }, _attrs))}><div class="flex items-center gap-2"><template><div class="text-2xl font-bold">`);
      if (unref(user)) {
        ...
        _push(`<span>My Finance Tracker</span>`);
      }
      _push(`</div></template>`);
...
//# sourceMappingURL=default-DH52dN_8.mjs.map

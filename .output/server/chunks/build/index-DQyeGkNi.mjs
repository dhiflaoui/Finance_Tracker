import { c as __nuxt_component_1$2, d as __nuxt_component_4$1, e as appConfig, f as useAppConfig, g as classNames, _ as _export_sfc, u as useSupabaseUser, h as __nuxt_component_2$1, i as useNuxtApp, j as asyncDataDefaults, k as createError } from './server.mjs';
import { defineComponent, computed, ref, watch, provide, h, cloneVNode, reactive, toRaw, onMounted, Fragment, watchEffect, inject, onUnmounted, nextTick, unref, getCurrentInstance, Teleport, normalizeClass, useSSRContext, withAsyncContext, mergeProps, isRef, withCtx, createVNode, withKeys, shallowRef, toRefs, toDisplayString, openBlock, createBlock, createCommentVNode, withModifiers, createTextVNode, resolveComponent, resolveDynamicComponent, renderSlot, renderList, Transition, toRef, onServerPrefetch } from 'vue';
import { useDebounceFn, computedAsync } from '@vueuse/core';
import { q as defu } from '../runtime.mjs';
import { c as c$1, f as f$2, w as w$2, t as t$3, i as i$2, l as l$2, a as i$1$1, u as u$1$1, p, s as s$2, b as usePopper, n as n$1, d as w$1$1, e as t$1$1, _ as __nuxt_component_3 } from './Dropdown-eQP4NCwU.mjs';
import { u as useFormEvents, a as useAppToast, _ as __nuxt_component_1$1$1, b as __nuxt_component_1$3 } from './useAppToast-BHAQYvqX.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderSlot } from 'vue/server-renderer';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { f as f$3, u as u$4, t as t$4, _ as __nuxt_component_1$4 } from './Card-DNKNvepj.mjs';
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-69b1567e><div class="${ssrRenderClass([[__props.color], "font-bold"])}" data-v-69b1567e>${ssrInterpolate(__props.title)}</div><div class="text-2xl font-extrabold text-black dark:text-white mb-2" data-v-69b1567e>`);
      if (__props.loading) {
        _push(ssrRenderComponent(_component_USkeleton, { class: "h-8 w-full" }, null, _parent));
      } else {
        _push(`<div data-v-69b1567e>${ssrInterpolate(unref(currency))}</div>`);
      }
      _push(`</div><div data-v-69b1567e>`);
      if (__props.loading) {
        _push(ssrRenderComponent(_component_USkeleton, { class: "h-6 w-full" }, null, _parent));
      } else {
        _push(`<div class="flex space-x-1 items-center text-sm" data-v-69b1567e></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-69b1567e"]]);
const _sfc_main$8 = {
  __name: "LineChart",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LineChart = _sfc_main$8;
      const _component_DoughnutChart = _sfc_main$7;
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, null, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="modal-header" data-v-c7c5879a${_scopeId2}><span data-v-c7c5879a${_scopeId2}>${ssrInterpolate(isEditing.value ? "Edit Transaction" : "Add Transaction")}</span>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c7c5879a"]]);
const _sfc_main$3 = {
...
const __nuxt_component_7 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b6dd2d18"]]);
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_TransactionsCharts = _sfc_main$6;
      const _component_UButton = __nuxt_component_2$1;
      const _component_TransactionModal = __nuxt_component_4;
      const _component_UFormGroup = __nuxt_component_1$1$1;
      const _component_UInput = __nuxt_component_1$3;
      const _component_DailyTransactionSummary = __nuxt_component_7;
      const _component_Transaction = _sfc_main$1;
      const _component_USkeleton = __nuxt_component_9;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col h-screen" }, _attrs))} data-v-37c67b84><div class="flex-none" data-v-37c67b84><section class="flex items-center justify-between mb-10" data-v-37c67b84><h1 class="text-xl font-extrabold" data-v-37c67b84>Summary</h1><div data-v-37c67b84>`);
      ...
      _push(`</div></section><section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 sm:gap-16 mb-10" data-v-37c67b84>`);
      ...
      _push(`</section>`);
      if (!unref(pending)) {
        _push(`<section class="mb-10" data-v-37c67b84>`);
        _push(ssrRenderComponent(_component_TransactionsCharts, { TransactionPerDate: unref(byDate) }, null, _parent));
        _push(`</section>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<section class="flex justify-between mb-10" data-v-37c67b84><div data-v-37c67b84><h2 class="text-2xl font-extrabold" data-v-37c67b84>Transaction</h2><div class="text-gray-500 dark:text-gray-400" data-v-37c67b84> You have ${ssrInterpolate(unref(incomeCount))} incomes and ${ssrInterpolate(unref(expenseCount))} expenses this period. </div></div><div class="flex items-center gap-4" data-v-37c67b84>`);
      ...
      if (unref(isSearchOpen)) {
        _push(`<section class="mb-4" data-v-37c67b84>`);
      ...
      _push(`</div><div class="flex-1 overflow-y-auto" data-v-37c67b84>`);
      if (!unref(pending)) {
        _push(`<section data-v-37c67b84><!--[-->`);
        ssrRenderList(unref(byDate), (transactionsOnDay2, date) => {
          _push(`<div class="mb-6" data-v-37c67b84>`);
          ...
          _push(`<div style="${ssrRenderStyle(!unref(collapsedGroups)[date] ? null : { display: "none" })}" class="pl-6 border-l-2 border-gray-100 dark:border-gray-800 ml-2" data-v-37c67b84><!--[-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-37c67b84"]]);

export { index as default };
//# sourceMappingURL=index-DQyeGkNi.mjs.map
